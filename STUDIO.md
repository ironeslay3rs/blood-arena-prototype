...
- [README.md](README.md) — setup, scripts, optional netplay env (`NEXT_PUBLIC_NETPLAY_RELAY_URL`), links to design docs  
- [docs/BLOOD_ARENA_MASTER_PLAN.md](docs/BLOOD_ARENA_MASTER_PLAN.md) — milestones M0–M4, work streams **A–F** (**F** = persistent **upgrade/growth** hook); **§1** + **§15** (player promise **“I keep upgrading”**, pillar **Growth**, rubric **T5**); **BP-27–45**  
